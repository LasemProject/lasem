...
#define LSM_MATHML_TYPE_UNDER_OVER_ELEMENT             (lsm_mathml_under_over_element_get_type ())
#define LSM_MATHML_UNDER_OVER_ELEMENT(obj)             (G_TYPE_CHECK_INSTANCE_CAST ((obj), LSM_MATHML_TYPE_UNDER_OVER_ELEMENT, LsmMathmlUnderOverElement))
#define LSM_MATHML_UNDER_OVER_ELEMENT_CLASS(klass)     (G_TYPE_CHECK_CLASS_CAST ((klass), LSM_MATHML_TYPE_UNDER_OVER_ELEMENT, LsmMathmlUnderOverElementClass))
#define LSM_MATHML_IS_UNDER_OVER_ELEMENT(obj)          (G_TYPE_CHECK_INSTANCE_TYPE ((obj), LSM_MATHML_TYPE_UNDER_OVER_ELEMENT))
#define LSM_MATHML_IS_UNDER_OVER_ELEMENT_CLASS(klass)  (G_TYPE_CHECK_CLASS_TYPE ((klass), LSM_MATHML_TYPE_UNDER_OVER_ELEMENT))
#define LSM_MATHML_UNDER_OVER_ELEMENT_GET_CLASS(obj)   (G_TYPE_INSTANCE_GET_CLASS((obj), LSM_MATHML_TYPE_UNDER_OVER_ELEMENT, LsmMathmlUnderOverElementClass))
