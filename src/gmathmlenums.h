...
/* Keep in sync with gmathml_pango_options in gmathml_view */
typedef enum {
	...
	GMATHML_VARIANT_FRAKTUR_BOLD,
	GMATHML_VARIANT_SCRIPT,
	GMATHML_VARIANT_SCRIPT_BOLD,
	GMATHML_VARIANT_FRAKTUR,
	GMATHML_VARIANT_SANS_SERIF,
	GMATHML_VARIANT_SANS_SERIF_BOLD,
