...
#define LSM_TYPE_SVG_STOP_ELEMENT             (lsm_svg_stop_element_get_type ())
#define LSM_SVG_STOP_ELEMENT(obj)             (G_TYPE_CHECK_INSTANCE_CAST ((obj), LSM_TYPE_SVG_STOP_ELEMENT, LsmSvgStopElement))
#define LSM_SVG_STOP_ELEMENT_CLASS(klass)     (G_TYPE_CHECK_CLASS_CAST ((klass), LSM_TYPE_SVG_STOP_ELEMENT, LsmSvgStopElementClass))
#define LSM_IS_SVG_STOP_ELEMENT(obj)          (G_TYPE_CHECK_INSTANCE_TYPE ((obj), LSM_TYPE_SVG_STOP_ELEMENT))
