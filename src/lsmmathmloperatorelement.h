...
#define LSM_MATHML_TYPE_OPERATOR_ELEMENT             (lsm_mathml_operator_element_get_type ())
#define LSM_MATHML_OPERATOR_ELEMENT(obj)             (G_TYPE_CHECK_INSTANCE_CAST ((obj), LSM_MATHML_TYPE_OPERATOR_ELEMENT, LsmMathmlOperatorElement))
#define LSM_MATHML_OPERATOR_ELEMENT_CLASS(klass)     (G_TYPE_CHECK_CLASS_CAST ((klass), LSM_MATHML_TYPE_OPERATOR_ELEMENT, LsmMathmlOperatorElementClass))
#define LSM_MATHML_IS_OPERATOR_ELEMENT(obj)          (G_TYPE_CHECK_INSTANCE_TYPE ((obj), LSM_MATHML_TYPE_OPERATOR_ELEMENT))
#define LSM_MATHML_IS_OPERATOR_ELEMENT_CLASS(klass)  (G_TYPE_CHECK_CLASS_TYPE ((klass), LSM_MATHML_TYPE_OPERATOR_ELEMENT))
#define LSM_MATHML_OPERATOR_ELEMENT_GET_CLASS(obj)   (G_TYPE_INSTANCE_GET_CLASS((obj), LSM_MATHML_TYPE_OPERATOR_ELEMENT, LsmMathmlOperatorElementClass))
