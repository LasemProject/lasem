...
#define LSM_TYPE_SVG_GRAPHIC             (lsm_svg_graphic_get_type ())
#define LSM_SVG_GRAPHIC(obj)             (G_TYPE_CHECK_INSTANCE_CAST ((obj), LSM_TYPE_SVG_GRAPHIC, LsmSvgGraphic))
#define LSM_SVG_GRAPHIC_CLASS(klass)     (G_TYPE_CHECK_CLASS_CAST ((klass), LSM_TYPE_SVG_GRAPHIC, LsmSvgGraphicClass))
#define LSM_IS_SVG_GRAPHIC(obj)          (G_TYPE_CHECK_INSTANCE_TYPE ((obj), LSM_TYPE_SVG_GRAPHIC))
