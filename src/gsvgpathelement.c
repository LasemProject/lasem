...
static void
gsvg_path_element_graphic_render (GSvgElement *self, GSvgView *view)
{
	GSvgPathElement *path;

	path = GSVG_PATH_ELEMENT (self);

	gdom_debug ("[GSvgPathElement::graphic_render]");
...
gsvg_path_element_class_init (GSvgPathElementClass *s_rect_class)
{
	...
	s_graphic_class->graphic_render = gsvg_path_element_graphic_render;
