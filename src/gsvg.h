...
typedef struct _GSvgDefsElement GSvgDefsElement;
typedef struct _GSvgUseElement GSvgUseElement;
typedef struct _GSvgSymbolElement GSvgSymbolElement;
...
typedef struct _GSvgLineElement GSvgLineElement;
typedef struct _GSvgPolylineElement GSvgPolylineElement;
typedef struct _GSvgPolygonElement GSvgPolygonElement;
typedef struct _GSvgPathElement GSvgPathElement;
typedef struct _GSvgTextElement GSvgTextElement;
typedef struct _GSvgGradientElement GSvgGradientElement;
